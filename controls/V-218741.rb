...
control 'V-218741' do
  title "The IIS 10.0 website must produce log records that contain sufficient
information to establish the outcome (success or failure) of IIS 10.0 website
events."
...
the overall reconstruction of the loggable event. By determining the success or
