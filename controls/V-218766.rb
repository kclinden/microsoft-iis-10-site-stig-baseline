...
control 'V-218766' do
  title "The IIS 10.0 websites must use ports, protocols, and services
according to Ports, Protocols, and Services Management (PPSM) guidelines."
...
network-related services deemed to be non-essential to the server mission, too
unsecure, or prohibited by the PPSM CAL and vulnerability assessments.
...
PPSM, and the associated PPS Assurance Category Assignments List.
  "
  desc  'rationale', ''
  desc  'check', "
    Review the website to determine if HTTP and HTTPs (e.g., 80 and 443) are
used in accordance with those ports and services registered and approved for
use by the DoD PPSM. Any variation in PPS will be documented, registered, and
approved by the PPSM.
    ...
    Review the ports and protocols. If unknown ports or protocols are used,
