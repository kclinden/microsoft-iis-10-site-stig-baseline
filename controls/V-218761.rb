...
control 'V-218761' do
  title "Debugging and trace information used to diagnose the IIS 10.0 website
must be disabled."
...
risk of application information being displayed to users."
  desc  'rationale', ''
  desc  'check', "
    Note: If the \".NET feature\" is not installed, this check is Not
Applicable.
    ...
    Scroll down to the \"Behavior\" section and verify the value for \"Debug\"
is set to \"False\".
