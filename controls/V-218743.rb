...
control 'V-218743' do
  title "The IIS 10.0 website must have Multipurpose Internet Mail Extensions
...
needed for the user's job role, or could use the function in an unintentional
manner.
