...
accessing a DoD private website."
  desc  "A consent banner will be in place to inform prospective entrants the
website they are about to enter is a DoD website and their activity is subject
...
Agreement for details.”
    ...
    If your system cannot meet the character limits to store this amount of
text in the banner, the following is another option for the warning banner:

    \"I've read & consent to terms in IS user agreem't.\"

    NOTE: While DoDI 8500.01 does not contain a copy of the banner to be used,
it does point to the RMF Knowledge Service for a copy of the required text. It
is also noted that the banner is to be displayed only once when the individual
...
entry, this is a finding.
  "
  desc  'fix', "Configure a DoD private website to display the required DoD
